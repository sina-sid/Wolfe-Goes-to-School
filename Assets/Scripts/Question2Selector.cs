...
public class Question2Selector : MonoBehaviour {
	...
	void Start () {
		...
		question2_list.Add(0, "Which one of your classmates annoys you the most?");
		question2_list.Add(1, "What are your plans for after school?");
